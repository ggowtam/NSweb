...
const images = [
  { img1: presetImage1, img2: presetImage2, label: 'REGAL 1' },
  { img1: presetImage3, img2: presetImage4, label: 'REGAL 2' },
  { img1: presetImage5, img2: presetImage6, label: 'REGAL 3' },
  { img1: presetImage7, img2: presetImage8, label: 'REGAL 4' },
  { img1: presetImage9, img2: presetImage10, label: 'REGAL 5' },
  { img1: presetImage11, img2: presetImage12, label: 'REGAL 6' },
];

const RegalPreset = () => {
  const presetName = 'Regal Tones';
  const price = 39.99;
  const description = `
    Adobe Lightroom & Adobe Camera Raw presets working on Lightroom Classic CC, 6, 5 & 4 and Photoshop CC & CS6.
    The Regal Tones presets are perfect for elegant and sophisticated photography. Ideal for portrait and wedding photography.
