...
const images = [
  { img1: presetImage1, img2: presetImage2, label: 'FILM PACK 1' },
  { img1: presetImage3, img2: presetImage4, label: 'FILM PACK 2' },
  { img1: presetImage5, img2: presetImage6, label: 'FILM PACK 3' },
  { img1: presetImage7, img2: presetImage8, label: 'FILM PACK 4' },
  { img1: presetImage9, img2: presetImage10, label: 'FILM PACK 5' },
  { img1: presetImage11, img2: presetImage12, label: 'FILM PACK 6' },
];

const FilmPackPreset = () => {
  const presetName = 'Film Pack';
  const price = 34.99;
  const description = `
    Adobe Lightroom & Adobe Camera Raw presets working on Lightroom Classic CC, 6, 5 & 4 and Photoshop CC & CS6.
    The Film Pack presets are designed to emulate classic film looks. Perfect for photographers looking for a vintage film style.
